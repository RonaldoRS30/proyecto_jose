...
import { Zap, Receipt, Percent, MapPin, Info, Plus, Equal } from 'lucide-react';
...
function SubtotalLine({ icon: Icon, label, value, unit = 'currency', operator }) {
  return (
    <div className="factura-line">
      ...
      <div className="factura-line-body">
...
export default function FacturaBreakdown({ factura, precioKwh, consumoMesFallback }) {
  ...
  const subtotalItems = [
    { icon: Zap, label: 'Consumo de Energía', value: data.consumoKwh, unit: 'kwh' },
        ...
        <div className="factura-lines">
          ...
          <div className="factura-subtotal-box">
            ...
            <small className="factura-formula">
              {formatNumber(data.consumoKwh)} + {formatCurrency(data.cargoFijo).replace('S/ ', '')}
