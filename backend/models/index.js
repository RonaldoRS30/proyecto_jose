...
const Cliente = sequelize.define(
  'Cliente',
  {
    ...
    electrificacion_rural: { type: DataTypes.DECIMAL(10, 2), allowNull: true },
...
const Electrodomestico = sequelize.define(
  'Electrodomestico',
  {
    ...
    eficiencia_energetica: { type: DataTypes.BOOLEAN, defaultValue: false },
    tipo_eficiencia: { type: DataTypes.STRING(50), allowNull: true },
    plantilla_eficiencia: { type: DataTypes.STRING(50), allowNull: true },
    kwh_por_ciclo: { type: DataTypes.DECIMAL(10, 4), allowNull: true },
    horas_por_ciclo: { type: DataTypes.DECIMAL(10, 4), allowNull: true },
    minutos_por_ciclo: { type: DataTypes.DECIMAL(10, 2), allowNull: true },
    kwh_anual: { type: DataTypes.DECIMAL(10, 2), allowNull: true },
    btu_h: { type: DataTypes.DECIMAL(12, 2), allowNull: true },
    hp: { type: DataTypes.DECIMAL(10, 4), allowNull: true },
...
const Recomendacion = sequelize.define(
  'Recomendacion',
  {
    ...
    eficiencia_habilitada: { type: DataTypes.BOOLEAN, defaultValue: false },
    plantilla_eficiencia: { type: DataTypes.STRING(50), allowNull: true },
    eficiencia_config: { type: DataTypes.JSON, allowNull: true, defaultValue: null },
    activo: { type: DataTypes.BOOLEAN, defaultValue: true },
